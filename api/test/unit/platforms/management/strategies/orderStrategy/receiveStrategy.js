...
describe('Receive Strategy.', function () {
  ...
  describe('fn(): manageNewType()', function () {
    ...
    beforeEach(() => {
      ...
      const optionsMock = {};
      createObjectStub = sandbox
        .stub(ReceiveStrategy.prototype, 'createObjectsUpdate')
        .withArgs()
        .returns({
          updateQuery: updateQueryMock,
          findQuery: findQueryMock,
          options: optionsMock
        });
      updateNewStub = sandbox
        .stub(ReceiveStrategy.prototype, 'updateNew')
        .withArgs()
        .resolves();
    });
    afterEach(() => {
    ...
    it('should receive the order correctly', async function () {
      findNewStub = sandbox
        .stub(ReceiveStrategy.prototype, 'findNew')
  ...
  describe('fn(): createObjectsUpdate()', function () {
    it('should create the trace correctly', async function () {
      sandbox.stub(ReceiveStrategy.prototype, 'createTrace');
