...
describe('THIRDPARTY - Platform parser', function () {
    ...
    describe('parse new order', function () {
        it('should return new croni order parsed.', async function () {
            ...
            let return_new = await thirdParty.newsFromOrders(croni_order, platform, newsCod, stateCod, branch);
        ...
        it('should return new croni promotion order parsed.', async function () {
                ...
                "order": {
                    ...
                    "details": [{
                        ...
                        "optionGroups": [{
                            ...
                            "sku": "64",
                            "unitPrice": "110",
                            "notes": "Granizado. Cantidad: 1 - Dulce de leche.     Cantidad: 1 - Banana. Cantidad: 1 - Limon. Cantidad: 1"
                        },
                        {
                            "id": 50,
                            "name": "Segundo kilo",
            ...
            const croni_new = {
                ...
                order: {
                    ...
                    },
                    {
                        ...
                        groupId: 1,
                        optionalText: "Granizado. Cantidad: 1 - Dulce de leche.     Cantidad: 1 - Banana. Cantidad: 1 - Limon. Cantidad: 1",
                        productId: 49,
                        promo: 1,
                        count: 1,
                        sku: "64",
            ...
            sandbox.stub(NewsStateSingleton, 'idByCod').returns(3);
            sandbox.stub(NewsTypeSingleton, 'idByCod').returns(1);
            const return_new = await thirdParty.newsFromOrders(croni_order, platform, newsCod, stateCod, branch);
            expect(return_new).to.eql(croni_new);
        });
    });
    ...
    describe('retrive minimun data order', function () {
        context('order with platform format', function () {
            it('should return minium data of the order.', function () {
                ...
                expect(thirdParty.retriveMinimunData(croni_order)).to.eql({ branchReference: 211, id: 50194 });
            });
        });
    });
});